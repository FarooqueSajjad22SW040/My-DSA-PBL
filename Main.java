...
public class Main {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Student student = new Student(gender, group, parentalEducation, lunch, testPreparation, mathScore, readingScore, writingScore);
    ...
    //  maleHead.print(q1.parentalLevelQueue[0]);
     ...
     // q1.groupPerformanceAtParentalLevel();
      //  maleHead.print(q1.parentalLevelQueue[0].next);
        q1.medianOfAvgOfMaleAndFemale();

      //q1.betterPerformanceAtParentalLevel();
  //    q1.displayQueues();//
   ...
   //     queueForGroups.displayQueues();
       // queueForGroups.bestAvgMarksOfGroups();
        //maleHead.print(q1.parentalLevelQueue[0].head);
